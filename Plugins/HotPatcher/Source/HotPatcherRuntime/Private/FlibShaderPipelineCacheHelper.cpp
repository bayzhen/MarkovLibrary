...
{
	UE_LOG(LogHotPatcher,Display,TEXT("Load Shader pipeline cache %s for platform %d"),*Name,*FDataDrivenShaderPlatformInfo::GetShaderFormat(GMaxRHIShaderPlatform).ToString());
